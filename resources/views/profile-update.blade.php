                    ...
                    <div class="col-8">
                        <div class="container-fluid">
                            <div class="row pt-4">
                                ...
                                <div class="col-9">
                                    <input name="name" class="form-control" type="text" value="{{ $student->name }}">
                                </div>
                            </div>
                            ...
                            <div class="row pt-4">
                                ...
                                <div class="col-9">
                                    <input name="email" class="form-control" type="text" value="{{ $student->email }}">
                                </div>
                            </div>
                            ...
                            <div class="row pt-4">
                                ...
                                <div class="col-9">
                                    <input name="phone_number" class="form-control" type="text" value="{{ $student->phone_number }}">
                                </div>
                            </div>
                            <div class="row pt-5">
                                <div class="col-12">
