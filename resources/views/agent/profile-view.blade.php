                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row pt-4">
                            <div class="col-6  pt-4">
                                <a class="btn text-uppercase btn-primary w-100" href="{{ route('agent.profile-update') }}">Update Profile</a>
                            </div>
                            <div class="col-6 pt-4">
                                <a class="btn btn-warning text-uppercase w-100" href="{{ route('agent.change-password') }}">Change Password</a>
                            </div>
                            <div class="col-6 pt-4">
                                <a class="btn btn-danger text-uppercase w-100" href="{{ route('agent.delete') }}">Delete Account</a>
                            </div>
                            <div class="col-6 pt-4">
