		...
		<article>
			...
			<table class="meta">
				...
				<tr>
					...
					<td><span id="prefix">RM</span><span>{{ $transaction->amount }}</span></td>
				</tr>
			</table>
			<table class="inventory">
				<thead>
					<tr>
						...
						<th><span>Contract Start Date</span></th>
						<th><span>Contract End Date</span></th>
				...
				<tbody>
					<tr>
						...
						<td>{{ $reservation->contract_start_date }}</td>
						<td>{{ $reservation->contract_end_date }}</td>
			...
			<table class="balance">
				<tr>
					...
					<td><span data-prefix>RM</span><span>{{ $transaction->amount }}</span></td>
				</tr>
			</table>
		</article>
