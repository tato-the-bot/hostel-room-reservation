...
<html>
    ...
    <body>
        ...
        <form class="container pb-4" method="POST" action="{{ route('admin.profile-update') }}" enctype="multipart/form-data">
            @if(count($errors) > 0) 
                    ...
                    <div class="col-8">
                        <div class="container-fluid">
                            ...
                            <div class="row pt-4">
                                ...
                                <div class="col-9">
                                    <input name="phone_number" class="form-control" type="text" value="{{ $admin->phone_number }}" required>
                                </div>
                            </div>
                            <div class="row pt-5">
                                <div class="col-12">
